    ...
    render() {
        return (
            <div className="Section About">
                ...
                <p>A sought-after teacher in the New York City area, Mirchandani maintains a successful private studio and serves as a Teaching Artist for Midori & Friends. His students routinely receive top honors in exams and competitions, including invitations to perform in Carnegie Hall. He taught a masterclass at the Carnegie Mellon Preparatory School of Music in 2024 and has served as a Graduate Teaching Fellow at the Mannes School of Music.</p>
                ...
                <p> In 2021, Mirchandani completed his master's degree at the Manhattan School of Music, where he was a winner of the President's Award scholarship and was named to the Dean's List in each of his four terms. He was a pupil of Jeffrey Cohen and Solomon Mikowsky. In 2023, Mirchandani earned his Professional Studies Diploma at the Mannes School of Music, where he studied with Thomas Sauer and taught undergraduates as a Teaching Fellow. He was given the coveted Steinway Award for artistic excellence and service to Mannes.</p>
            
                <p> In 2024, Mirchandani will begin pursuing an Artist Diploma at the Royal College of Music in London. </p>
            </div>
        )
    }
}
