    ...
    render() {
        return (
            <div className="Section About">
                ...
                <p> Mirchandani made his first of four appearances at Carnegie Hall in New York at the age of 12. He has also performed internationally in Germany, Italy, Portugal, Spain, and the United Kingdom.</p>

                <p> He has participated in masterclasses with a number of illustrious pianists, among them Richard Goode, Boris Berman, <a href="#langlang">Lang Lang</a>, Eldar Nebolsin, and Wei-Yi Yang. Mirchandani's <a href="#preludes">2014 recording</a> of Nancy Galbraith's Three Preludes for Piano was featured on the acclaimed Centaur Records album <i>Strange Travels</i>, which garnered a spot on the "Want List" in <i>Fanfare Magazine</i>.</p>
